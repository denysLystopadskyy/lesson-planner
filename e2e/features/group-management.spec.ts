...
addGroupTest.describe(
  "Group management — state transition testing @ported",
  () => {
...
editGroupTest.describe(
  "Group editing — state transition testing @ported",
  () => {
    editGroupTest(
...
deleteGroupTest.describe(
  "Group deletion — state transition testing @ported",
  () => {
    deleteGroupTest(
