...
| 43h | [5.2a](p5-02a-better-auth.md)                 | Better Auth, the allowlist, the test-only door  | 5.1b                     |
| 43i | [5.2b](p5-02b-api-routing-and-rate-limit.md)  | The catch-all matched one segment               | 5.2a                     |
